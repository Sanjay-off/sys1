...
# # #     # TODO: Add middleware checks (force_sub, verification) in Phase 2
...
# # #                 # Get file name to check if it's zip
# # #                 # For now, we'll add password to all documents
# # #                 # In production, you'd check the actual filename
